...
const CoordinatorsSection = () => {
  return (
    <section id="Co-ordinators" className="py-14 bg-white">
      <h2 className="text-3xl font-bold text-purple-500 text-center mb-8">Co-ordinators</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-6 pb-8">
        {coordinators.map((coordinator, index) => (
          <div
            key={index}
            className="bg-white shadow-xl p-6 rounded-2xl transition-transform transform hover:scale-105 border-t-4 border-l-3 border-purple-500 text-center"
          >
